...
export interface VehicleServiceController {
  ...
  findAllVehicles(request: Empty2): Promise<VehicleList> | Observable<VehicleList> | VehicleList;
  ...
  findAvailableVehicles(request: Empty2): Promise<VehicleList> | Observable<VehicleList> | VehicleList;
  ...
  findAllVehicleLocations(request: Empty2): Promise<VehicleLocation> | Observable<VehicleLocation> | VehicleLocation;
